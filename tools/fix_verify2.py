# -*- coding: utf-8 -*-
"""修复后验证: Melodiniq 分音特征 (fast_ms/miniburst)"""
...
print(f'{"谱":<16}{"fast050":>8}{"fast100":>8}{"fast150":>8}{"miniburst":>10}{"globaljack":>11}')
for nm, p in cases:
    f_ = stats(p)
    print(f'{nm:<16}{f_.get("fast_ms_050_ratio",0):>8.3f}{f_.get("fast_ms_100_ratio",0):>8.3f}{f_.get("fast_ms_150_ratio",0):>8.3f}{f_.get("miniburst_count",0):>10}{f_.get("global_jack_count",0):>11}')
print('DONE')