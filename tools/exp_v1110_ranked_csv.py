...
with open(os.path.join(_ROOT, 'data', 'phira', 'v1110_ranked_predictions.csv'), 'w', encoding='utf-8-sig', newline='') as f:
    w = csv.writer(f)
...
print('已保存: v1110_ranked_predictions.csv')
print('DONE')
