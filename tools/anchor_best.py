...
OV = {'drag_per_sec':0.3, 'density_transition_std':0.3, 'jack_max_run':0.5, 'eff_peak_tps_1s':1.4, 'above_avg_duration_sec':1.15, 'jline_movement_density':0.5}
...
print('=== 锚点 (新组合) ===')
for i, (nm, tgt, _, _) in enumerate(anchors):
    print(f'  {nm:<16} 锚点={tgt:.2f} 预测={ps_a[i]:.2f} 差={ps_a[i]-tgt:+.2f}')
