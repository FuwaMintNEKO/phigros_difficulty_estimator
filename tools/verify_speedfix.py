...
for nm, p1, p2 in pairs:
    ...
    print(f'\n{nm}:')
    for k in ['speed_mean', 'speed_std', 'speed_max', 'speed_range', 'speed_volatility', 'speed_event_count']:
        print(f'  {k:<22} 高仿={f1.get(k,0):.2f} 官谱={f2.get(k,0):.2f}')
print('DONE')