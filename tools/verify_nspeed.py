...
for nm, p1, p2 in pairs:
    ...
    print(f'\n{nm}:')
    for k in ['note_speed_non1_count','note_speed_non1_ratio','note_speed_std','note_speed_max','note_speed_density','fast_hold_count','fast_hold_ratio']:
        print(f'  {k:<24} 高仿={f1.get(k,0):.2f} 官谱={f2.get(k,0):.2f}')
print('DONE')