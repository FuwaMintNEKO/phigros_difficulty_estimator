...
charts = [
    ...
    ("Rrharil AT",              os.path.join(_ROOT, 'data', 'chart', 'Rrharil.TeamGrimoire.0'), 'AT.json', 17.6),
    ("QZKagoRequiem AT",        os.path.join(_ROOT, 'data', 'chart', 'QZKagoRequiem.tpazolite.0'), 'AT.json', 17.4),
]
